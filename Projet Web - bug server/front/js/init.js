...
function init_pion(i,j,data){
	if(data == "Espion"){
		temparray[i][j] = new pion('Espion',1,JSON.parse(sessionStorage.getItem('team')));
	}
    	...
    	temparray[i][j] = new pion('Eclaireur',2,JSON.parse(sessionStorage.getItem('team')));
    }
    else if(data == "Demineur1" || data == "Demineur2" || data == "Demineur3" || data == "Demineur4" || data == "Demineur5"){
    	temparray[i][j] = new pion('Demineur',3,JSON.parse(sessionStorage.getItem('team')));
    }
    else if(data == "Sergent1" || data == "Sergent2" || data == "Sergent3" || data == "Sergent4"){
    	temparray[i][j] = new pion('Sergent',4,JSON.parse(sessionStorage.getItem('team')));
    }    
    else if(data == "Lieutenant1" || data == "Lieutenant2" || data == "Lieutenant3" || data == "Lieutenant4"){
    	temparray[i][j] = new pion('Lieutenant',5,JSON.parse(sessionStorage.getItem('team')));
    }          
    else if(data == "Capitaine1" || data == "Capitaine2" || data == "Capitaine3" || data == "Capitaine4"){
    	temparray[i][j] = new pion('Capitaine',6,JSON.parse(sessionStorage.getItem('team')));	
    }       
    else if(data == "Commandant1" || data == "Commandant2" || data == "Commandant3"){
    	temparray[i][j] = new pion('Commandant',7,JSON.parse(sessionStorage.getItem('team')));	
    }      
    else if(data == "Colonel1" || data == "Colonel2"){
    	temparray[i][j] = new pion('Colonel',8,JSON.parse(sessionStorage.getItem('team')));
    }            
    else if(data == "General"){
    	temparray[i][j] = new pion('General',9,JSON.parse(sessionStorage.getItem('team')));	
    }            
    else if(data == "Marechal"){
    	temparray[i][j] = new pion('Marechal',10,JSON.parse(sessionStorage.getItem('team')));	
    }        
    else if(data == "Drapeau"){
    	temparray[i][j] = new pion('Drapeau',0,JSON.parse(sessionStorage.getItem('team')));	
    }
    else if(data == "Bombes1" || data == "Bombes2" || data == "Bombes3" || data == "Bombes4" || data == "Bombes5" || data == "Bombes6"){
    	temparray[i][j] = new pion('Bombes',100,JSON.parse(sessionStorage.getItem('team')));
    }          
}
...
function ready(){
 ...
 (() => {
        ...
        socket.on('finalarray', (array) => {
            sessionStorage.setItem('table', JSON.stringify(array));
        });
